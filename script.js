        ...
        if (adjustOption === null) {
          ...
          while (!exitLengthOption) {
            var desiredLength = window.prompt(
              "How long would you like your password to be? Your password must be longer than 8 (inclusive) and shorter than 128 (inclusive) characters. Please key in the length in number."
            );
